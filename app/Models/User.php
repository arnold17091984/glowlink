 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Talk> $recievedBy
 * @property-read int|null $recieved_by_count
...
class User extends Authenticatable implements FilamentUser
{
    ...
    public function recievedBy(): MorphMany
    {
        return $this->morphMany(Talk::class, 'receiver');
    }
}
